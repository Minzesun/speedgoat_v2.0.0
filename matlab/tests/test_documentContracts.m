...
verifyTrue(testCase, contains(runbook, 'data/reference/position_reference_6064.txt'));
verifyTrue(testCase, contains(runbook, 'position_reference_6064'));
...
verifyTrue(testCase, contains(boundary, 'reference'));
...
verifyTrue(testCase, contains(reference, 'SGV2_POSITION_REFERENCE_FEEDFORWARD_ENABLED'));
verifyTrue(testCase, contains(reference, 'SGV2_REFERENCE_PLAY_REQUEST'));
verifyTrue(testCase, contains(reference, 'SGV2_HOME_TO_ZERO_REQUEST'));
verifyTrue(testCase, contains(reference, 'SGV2_HOME_TO_ZERO_SPEED'));
verifyTrue(testCase, contains(reference, 'data/reference/position_reference_6064.txt'));
verifyTrue(testCase, contains(reference, 'position_reference_6064'));
verifyTrue(testCase, contains(reference, 'position_rate_reference_6064'));
verifyTrue(testCase, contains(reference, 'SGV2_POSITION_LOOP_ENABLED'));
verifyTrue(testCase, contains(reference, '不再'));
...
verifyTrue(testCase, contains(tuning, '每行一个相对位置点'));
verifyTrue(testCase, contains(tuning, '0.001 mm/count'));
verifyTrue(testCase, contains(tuning, 'Data Inspector'));
verifyTrue(testCase, contains(tuning, 'SGV2_POSITION_REFERENCE_FEEDFORWARD_ENABLED'));
verifyTrue(testCase, contains(tuning, 'SGV2_REFERENCE_PLAY_REQUEST'));
verifyTrue(testCase, contains(tuning, 'SGV2_HOME_TO_ZERO_REQUEST'));
verifyTrue(testCase, contains(tuning, 'SGV2_HOME_TO_ZERO_SPEED'));
verifyTrue(testCase, contains(tuning, '点击 Start'));
verifyTrue(testCase, contains(tuning, 'ready_to_run = 1'));
...
verifyTrue(testCase, contains(logic, 'PositionVelocityGain = 1000'));
verifyTrue(testCase, contains(logic, 'position_rate_ref'));
verifyTrue(testCase, contains(logic, 'speed_ff = position_rate_ref / 1000'));
verifyTrue(testCase, contains(logic, 'Position Reference Source'));
verifyTrue(testCase, contains(logic, 'data/reference/position_reference_6064.txt'));
...
verifyTrue(testCase, contains(logic, 'SGV2_POSITION_REFERENCE_FEEDFORWARD_ENABLED'));
verifyTrue(testCase, contains(logic, 'SGV2_REFERENCE_PLAY_REQUEST'));
verifyTrue(testCase, contains(logic, 'SGV2_HOME_TO_ZERO_REQUEST'));
verifyTrue(testCase, contains(logic, 'SGV2_HOME_TO_ZERO_SPEED'));
